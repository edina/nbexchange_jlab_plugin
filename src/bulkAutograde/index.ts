...
export class BulkAutogradeWidget extends Widget {
  ...
  constructor(app: JupyterFrontEnd) {
    ...
    this.node.innerHTML = [
      ...
      '  </div>',
      '</div>',
      '<div id="baautograde-alert-danger" role="alert" class="nbex-alert nbex-alert-danger">',
      '</div>',
      '<div id="baautograde-alert-info" role="alert" class="nbex-alert nbex-alert-info">',
      '</div>',
